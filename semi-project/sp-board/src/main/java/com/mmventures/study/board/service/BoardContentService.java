...
public class BoardContentService {
    ...
    public void contentList(final Model model,
    		final int boardId,
    	    final int page,
    	    final int size,
    	    final int category,
    	...
    	List<BoardContent> contentList = boardContentDao.selectBoardContentList(boardId);
    ...
    public void contentDetail(final Model model,
    		final int boardId,
    		final int contentId) {
    	// TODO content 가져오기
	BoardContent content = boardContentDao.selectBoardContent(boardId, contentId);
	...
	model.addAttribute("fileList", fileList);
    	...
    	// TODO comment 가져오기
	List<ContentComment> commentList = contentCommentDao.selectCommentList(contentId);
	...
	// set categoryList
	List<CommonData> categoryList = boardInfoDao.getBoardCategoryList(boardId);
